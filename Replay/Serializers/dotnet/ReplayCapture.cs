...
public struct Transform
{
    ...
    public static readonly Transform Identity = new() { Rotation = Quaternion.Identity };
}
...
public class ReplayCaptureWriter : IReplayWriter, IDisposable
{
    ...
    private readonly Dictionary<object, Entity> EntityMapping = new();
    private int EntityCounter;
    private int FrameCounter;

    private readonly Dictionary<Entity, Transform> LastTransforms = new();
    private readonly Dictionary<Entity, Dictionary<string, float>> LastParams = new();
...
public class Entity
{
    ...
    public bool HasParent => ParentId >= 0 && ParentId != Id;
}
...
public class BinaryWriterEx : BinaryWriter
{
    ...
    public new void Write7BitEncodedInt(int val) => base.Write7BitEncodedInt(val);
}
