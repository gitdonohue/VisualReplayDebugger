...
namespace _3DTools
{
    ...
    public class ScreenSpaceLines3D : ModelVisual3D
    {
        ...
        private bool UpdateTransforms()
        {
            ...
            //bool success = true;
            //Matrix3D visualToScreen = Matrix3D.Identity;//MathUtils.TryTransformTo2DAncestor(this, out viewport, out success);
            Matrix3D visualToScreen = GetVisualToViewportTransform?.Invoke() ?? Matrix3D.Identity;
